...
gcloud run deploy $SERVICE_NAME \
    ...
    --set-env-vars="ALLOYDB_INSTANCE=$ALLOYDB_INSTANCE,GOOGLE_CLOUD_PROJECT=$PROJECT_ID,GOOGLE_CLOUD_REGION=$REGION,DB_USER=postgres,DB_PASSWORD=SuperSecretPassword123!,DB_NAME=postgres,ALLOYDB_IAM_AUTH=False" \
    --project=$PROJECT_ID
